...
const ImageSlider = () => {
  ...
  return (
    <div className="relative m-auto h-[340px] w-full px-4 pt-4 group">
        <div style={{backgroundImage: `url(${slides[currentIndex]})`}} className="w-full h-full rounded-2xl bg-center bg-cover duration-200"></div>
